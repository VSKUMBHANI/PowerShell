...
[Parameter()]
[string]$IPRange = $(Read-host -prompt "Enter IP Range" )
...
Ori: https://github.com/luisfeliz79/PowerShell-IPrange-Regex
...
## Testing code
## 0..255| % { $current=$_;  ($current+1)..255 | % { Write-host "Min: $current Max: $_ Regex: $(RangeToRegex -min $current -max $_)" }}
